      ...
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-100">*2407</span>
              </li>
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white">
                ...
                <span className="text-gray-100">support@poalimflex.co.il</span>
              </li>
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white">
                ...
                <span className="text-gray-100">רוטשילד 50, תל אביב</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-100 mb-4">הירשמו לקבלת עדכונים ומבצעים חדשים</p>
            <div className="flex gap-2">
              <input 
                type="email" 
                placeholder="הכנס מייל" 
                className="bg-white/10 text-white border border-white/20 rounded-md px-4 py-2 w-full placeholder:text-gray-300"
              />
              <Button variant="secondary" className="bg-white hover:bg-gray-100 text-poalim-red">
                שלח
              </Button>
            </div>
          </div>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center">
          ...
          <div className="flex justify-center gap-6 mt-4 text-sm">
            <a href="#" className="text-gray-100 hover:text-gray-200">תנאי שימוש</a>
            <a href="#" className="text-gray-100 hover:text-gray-200">מדיניות פרטיות</a>
            <a href="#" className="text-gray-100 hover:text-gray-200">נגישות</a>
          </div>
        </div>
      </div>
    </footer>
